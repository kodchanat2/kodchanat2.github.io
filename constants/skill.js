...
const skills = [
  {
    ...
    list: [
      ...
      { name: 'TypeScript', alt: 'typescript', mono: true, level: level.e },
  ...
  },
  {
    ...
    list: [
      ...
      { name: 'React.js', alt: 'react', level: level.e },
      { name: 'Next.js', alt: 'nextjs', level: level.c },
      // { name: 'React-Native', alt: 'skill-alts:react-dark', level: level.b },
      { name: 'Vue.js', alt: 'vuejs', level: level.a },
      { name: 'Nuxt.js', alt: 'nuxtjs', level: level.e },
      ...
      { name: 'GSAP', alt: 'htmx', level: level.a },
  ...
  },
  {
    ...
    list: [
      ...
      { name: 'Postman', alt: 'postman', mono:true, level: level.a },
      { name: 'VS Code', alt: 'vscode', level: level.y },
      { name: 'npm', alt: 'npm', level: level.i },
      ...
      { name: 'Notion API', icon: 'logos:notion-icon', level: level.c },
