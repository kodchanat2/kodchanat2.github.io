<template>
  <form class="w-full relative flex flex-col text-black gap-2" @submit.prevent="handleSubmit">
    ...
    <button type="submit" :disabled="isLoading"
      class="w-full mt-1 p-3 bg-primary text-background text-lg font-medium rounded-lg transition hover:bg-primary/80">
    ...
    <div
      ...
      <div class="px-4 pb-8 rounded-3xl bg-background/90 flex flex-col justify-center items-center shadow-line shadow-text/25 text-center">
